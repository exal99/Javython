...
public final class Util {
  ...
  public static Object parse(BufferedReader br) throws Exception {
    LangScanner scanner = new LangScanner(br);
    LangParser parser = new LangParser();
    return parser.parse(scanner);
  }
  ...
  public static void testValidSyntax(BufferedReader br, String filename) {
    try {
      Util.parse(br);
    } catch (Exception e) {
  ...
  public static void testSyntax(File directory, String filename) {
    try {
      BufferedReader br = new BufferedReader(
        new FileReader(new File(directory, filename))
      );
      boolean valid = br.readLine().equals("// __valid__");
      if (valid) testValidSyntax(br, filename);
      else testSyntaxError(br, filename);
    } catch (Exception e) {
      fail("Unexpected error while parsing '" + filename + "': "
          + e.getMessage());
    }
  ...
  public static void testSyntaxError(BufferedReader br, String filename) {
